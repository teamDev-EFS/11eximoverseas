...
const Partnerships = () => {
  ...
  return (
    <>
      <SEO
        title="Partnerships & Business Opportunities | The 11 Exim Overseas | Global Trade Partners"
        description="Join The 11 Exim Overseas as a distributor, importer, or retailer. Explore exclusive partnership opportunities with India's leading agro-export company for global market expansion."
        keywords="The 11 Exim Overseas, 11 Exim Overseas, Exim Overseas India, partnerships, business opportunities, distributors, importers, retailers, global trade partners, agro export partnerships, India export partnerships"
        url="https://the11eximoverseas.com/partnerships"
      />
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-display font-bold text-gradient mb-8 text-balance">
                Partnership Opportunities with The 11 Exim Overseas
              </h1>
