...
const Team = () => {
  ...
  return (
    <>
      <SEO
        title="Meet Our Team | The 11 Exim Overseas | Leadership & Expertise"
        description="Meet the experienced leadership team of The 11 Exim Overseas. Learn about our directors, experts, and professionals driving India's premier agro-export company to global success."
        keywords="The 11 Exim Overseas, 11 Exim Overseas, Exim Overseas India, team, leadership, directors, experts, Hukam Chand Gupta, Yawal Gupta, agro export team, India export leadership"
        url="https://the11eximoverseas.com/team"
      />
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-display font-bold text-gradient mb-8 text-balance">
                Meet Our Team at The 11 Exim Overseas
              </h1>
              <p className="text-xl text-neutral-600 mb-12 leading-relaxed text-balance">
                ...
                experience in international trade, agriculture, and global
                market development to deliver exceptional results.
              </p>
            </motion.div>
          </div>
        </section>
